      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center">
          ...
          <div class="mx-auto text-center">
            ...
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="Approve.html" class="nav-link"><span>Approve Course</span></a></li>
              </ul>
            </nav>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mb-5">
            ...
            $sql = "SELECT course_name, course_id, fee, instructor, course_description FROM courses WHERE Approved=0";
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                ...
                echo '<p data-aos="fade-up" data-aos-delay="300"><a href="approve-by-button.php?course='.$row['course_id'].'"$course" ';
                echo 'class="btn btn-primary py-3 px-5 btn-pill">Approve</a></p>';
                echo '</div>';
              }
            } else {
              echo "0 results";
          ...
          <div class="col-lg-4 pl-lg-5">
            ...
            <div class="mb-5 text-center border rounded course-instructor">
              ...
              <div class="mb-4 text-center">
                ...
                <h3 class="h5 text-black mb-4">Nakhla Rafi</h3>
                <p>He reads in BRAC University</p>
              </div>
            </div>
